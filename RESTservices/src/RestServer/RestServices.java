...
/**
 * class to implement the rest services
 */
@Path("/employee")
public class RestServices {
	...
	public String getEmployeeById(String employeeId) {
		...
		try {
			...
			int result = facade.findEmployeeById(employee);
			
			if(result == 1) {
				
				resultStr = dataConversion.convertToJson(employee);
			} else if(result == 2) {
				
				resultStr = "No employee found with employee id: "+id;
			} else {
