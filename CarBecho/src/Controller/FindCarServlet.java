	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(facade.findCar(car)){
				...
				response.sendRedirect("/CarBecho/View/carDetailedViewUI.jsp?companyName="+car.getCompany()+"&modelName="+car.getModel()+
				...
				out.println("<a href='/CarBecho/View/index.jsp'>Home</a>");
